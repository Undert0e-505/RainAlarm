...
class RadarRendererLifecycleTest {
    ...
    fun `production shader interface matches exactly and contains both rendering paths`() {
        RadarShaderPrecision.entries.forEach { precision ->
            ...
            assertTrue("return value;" in fragment)
        }
        ...
        assertTrue("mix(sample.r, sample.a, coloredSource)" in RadarShaderSources.fragment)
        ...
        assertTrue("paletteIntensity" in RadarShaderSources.fragment)
